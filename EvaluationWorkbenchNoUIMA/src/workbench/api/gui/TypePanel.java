...
public class TypePanel extends JPanel implements TreeSelectionListener,
	...
	public WorkbenchAPIObject getRootTypeObject() {
		return rootTypeObject;
	}

	public void setRootTypeObject(WorkbenchAPIObject rootTypeObject) {
		this.rootTypeObject = rootTypeObject;
	}

	public TypeObjectMutableTreeNode getRootNode() {
		return rootNode;
	}

	public void setRootNode(TypeObjectMutableTreeNode rootNode) {
