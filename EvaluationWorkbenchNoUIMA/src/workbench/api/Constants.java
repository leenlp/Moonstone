...
public class Constants {
	...
	public static Dimension StatisticsPanelDimension = new Dimension(500, 1000);
	public static Dimension AttributePanelDimension = new Dimension(300, 200);
	public static Dimension ReportPanelDimension = new Dimension(150, 200);
	public static Dimension RelationPanelDimension = new Dimension(300, 200);
	public static Dimension AttributeTableScrollPaneDimension = new Dimension(400, 200);
	public static Dimension DocumentPanelDimension = new Dimension(700, 400);
