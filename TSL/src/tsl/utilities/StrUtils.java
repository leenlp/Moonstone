...
public class StrUtils {
	...
	// 2/26/2018
	public static String removeNumberFromMentionClassID(String mid) {
		if (mid != null && Character.isDigit(mid.charAt(0))) {
	...
	public static boolean stringsEndInSameDigits(String s1, String s2, int mincount) {
		if (s1 != null && s2 != null && Character.isDigit(s1.charAt(s1.length() - 1))
	...
	public static String replaceNonAlphaNumericCharactersWithDelim(String str, char delim) {
		StringBuffer sb = new StringBuffer();
	...
	public static String replaceNonDelimNonAlphaNumericCharactersWithSpaces(String str, char delim) {
		StringBuffer sb = new StringBuffer();
		boolean lastBlank = false;
		for (int i = 0; i < str.length(); i++) {
			char c = str.charAt(i);
	...
	public static String removeNonAlphaDigitArrayCharacters(String str, char[] array) {
		StringBuffer sb = new StringBuffer();
		for (int i = 0; i < str.length(); i++) {
			char c = str.charAt(i);
			if (Character.isDigit(c) || Character.isLetter(c) 
					|| VUtils.charInArray(c, array)) {
				sb.append(c);
			}
		}
		return sb.toString();
