...
public class FileIO {
		...
		if (subdirs != null) {
			for (File subdir : subdirs) {
				...
				if ("umls".equals(subdir.getName())) {
					...
					Ontology.createFromLisp(ostr, false);
				}
			}
		}
	}
	...
	public void writeAllKBFiles() throws Exception {
		...
		// 10/3/2017:  Just want to rewrite CUI file for now...
//		writeDictionaryFile();
//		writeOntologyFiles();
//		writeTUIFile();
	}
	...
	public void writeCUIFile() throws Exception {
		...
		if (cps != null) {
			...
			for (CUIStructureShort cs : cps) {
				...
				cuihash.put(cs.getCui(), cs.getCui());
			}
		}
		out.close();
	}
