...
public class KnowledgeBase {
	...
	public RelationConstant getPropertyConstant(String pname) {
		return this.getNameSpace().getPropertyConstant(pname);
	}
	
	public StringConstant getStringConstant(String scname) {
		return this.getNameSpace().getStringConstant(scname);
	}
