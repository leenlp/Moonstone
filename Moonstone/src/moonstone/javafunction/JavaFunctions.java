...
public class JavaFunctions {
	...
	private static Object[][] NumberWordValues = { { "one", new Float(1) }, { "two", new Float(2) },
			{ "three", new Float(3) }, { "four", new Float(4) }, { "five", new Float(5) }, { "six", new Float(6) },
			{ "seven", new Float(7) }, { "eight", new Float(8) }, { "nine", new Float(9) } };
	...
	// elements.
	public static Annotation getCoveringNarrativeAnnotation(StructureAnnotation sa) {
		return GrammarModule.CurrentGrammarModule.getCoveringNarrativeAnnotation(sa);
	}
	
	public static boolean coveredTextPercentGreaterThan(Annotation a, float coverage) {
		float f = (float) a.getCoveredTextPercent();
		return f > coverage;
	}
	...
	public static boolean ruleIDContainsStringRecursive(Annotation annotation, String str) {
	...
	public static boolean termStringContains(Object t, Object item) {
		if (t != null && item != null) {
			if (t.toString().toLowerCase().contains(item.toString().toLowerCase())) {
				return true;
			}
		}
		return false;
	...
	// 7/12/2018
	public static boolean annotationContainedInHeader(Annotation annotation) {
		Header h = annotation.getSentenceAnnotation().getSentence().getHeader();
		int hstart = h.getStart();
		int hend = h.getEnd();
		int astart = annotation.getTextStart();
		int aend = annotation.getTextEnd();
		boolean rv = (hstart <= astart && aend <= hend);
		return rv;
	}

	public static boolean headerContainsAllOf(Annotation annotation, Vector<String> strs) {
	...
	public static boolean headerContainsOneOf(Annotation annotation, Vector<String> strs) {
		Sentence s = annotation.getSentenceAnnotation().getSentence();
		Header h = s.getHeader();
		String hstr = h.getText().toLowerCase();
		for (String vstr : strs) {
	...
	public static boolean headerContainsSingleSentenceWithSingleWord(Annotation annotation) {
		Sentence s = annotation.getSentenceAnnotation().getSentence();
		Header h = s.getHeader();
	...
	public static String getDateString(Annotation annotation) {
		...
		if (c != null) {
			str = "<Month=" + c.get(Calendar.MONTH) + ",Day=" + c.get(Calendar.DAY_OF_MONTH) + ",Year="
					+ c.get(Calendar.YEAR) + ">";
		}
		return str;
	}
	...
	public static boolean notneg(Object o) {
		if (o instanceof Annotation) {
			return isNotNegated((Annotation) o);
		}
		return true;
	}
	...
	public static boolean isNegated(Annotation annotation) {
		return hasPropertyValue(annotation, "directionality", "negated")
				|| hasPropertyValue(annotation, "assertion", "negative")
				|| hasPropertyValue(annotation, "assertion", "negated") || conceptContainsString(annotation, "false");
	}

	public static boolean isAffirmed(Annotation annotation) {
		return hasPropertyValue(annotation, "directionality", "affirmed")
				|| hasPropertyValue(annotation, "assertion", "positive") || conceptContainsString(annotation, "true");
	}
	
	public static boolean isUncertain(Annotation annotation) {
		return hasPropertyValue(annotation, "directionality", "uncertain")
				|| hasPropertyValue(annotation, "assertion", "uncertain");
	}
	
	public static boolean isHypothetical(Annotation annotation) {
		return hasPropertyValue(annotation, "directionality", "hypothetical")
				|| hasPropertyValue(annotation, "assertion", "hypothetical");
	}
	...
	// ///////////////////////////////////////////////////////
	// 7/7/2016
	public static Object getConceptRecursive(Annotation annotation, Object concept) {
		String cstr = concept.toString();
		Object c = annotation.getConcept();
		if (c != null && c.toString().toLowerCase().contains(cstr.toLowerCase())) {
			return c;
		}
		if (annotation.hasChildren()) {
			for (Annotation child : annotation.getChildAnnotations()) {
	...
	public static boolean containsAllConcepts(Annotation annotation, Vector concepts) {
	...
	public static boolean containsSomeConcepts(Annotation annotation, Vector concepts) {
		for (Object concept : concepts) {
			if (hasConceptRecursive(annotation, concept)) {
				return true;
			}
	...
	public static boolean hasConceptRecursive(Annotation annotation, Object concept) {
	...
	public static boolean hasTypeRecursive(Annotation annotation, TypeConstant type) {
	...
	public static boolean hasConceptsRecursive(Annotation annotation, Vector concepts) {
		for (Object concept : concepts) {
	...
	public static boolean hasConcept(Annotation annotation, Object concept, boolean recursive) {
		if (annotation != null && concept != null) {
			Object c = annotation.getConcept();
			if (c != null && concept != null && c.toString().equals(concept.toString())) {
				return true;
			}
	...
	// 8/3/2016
	public static Annotation getAnnotationWithConcept(Annotation annotation, Object concept) {
		if (annotation != null && concept != null) {
			Object c = annotation.getConcept();
	...
	// 7/14/2016
	public static boolean hasType(Annotation annotation, TypeConstant type, boolean recursive) {
	...
	public static boolean conceptStartsWithString(Annotation annotation, String cstr) {
		boolean rv = annotation.hasConcept() && annotation.getConcept().toString().startsWith(cstr);
		return rv;
	}
	...
	public static boolean conceptContainsString(Object o, String cstr, boolean recursive) {
		if (o != null && cstr != null) {
	...
	public static Boolean setProperty(Annotation annotation, String pname, Object value) {
	...
	public static Object getPropertyRecursive(Annotation annotation, String property) {
	...
	public static boolean copcs(Annotation annotation, String property, String str) {
		return conceptOrPropertyContainsString(annotation, property, str, false);
	}

	public static boolean copcsr(Annotation annotation, String property, String str) {
		return conceptOrPropertyContainsString(annotation, property, str, true);
	}

	public static boolean conceptOrPropertyContainsString(Annotation annotation, String property, String str) {
		return conceptOrPropertyContainsString(annotation, property, str, false);
	}

	public static boolean conceptOrPropertyContainsStringRecursive(Annotation annotation, String property, String str) {
		return conceptOrPropertyContainsString(annotation, property, str, true);
	}

	public static boolean conceptOrPropertyContainsString(Annotation annotation, String property, String str,
			boolean recursive) {
		return (conceptContainsString(annotation, str, recursive)
				|| propertyValueContainsString(annotation, property, str, recursive));
	}

	public static boolean pvcs(Annotation annotation, String property, Object value) {
		return propertyValueContainsString(annotation, property, value, false);
	}

	public static boolean pvcsr(Annotation annotation, String property, Object value) {
		return propertyValueContainsStringRecursive(annotation, property, value);
	}

	public static boolean propertyValueContainsString(Annotation annotation, String property, Object value) {
		return propertyValueContainsString(annotation, property, value, false);
	}

	public static boolean propertyValueContainsStringRecursive(Annotation annotation, String property, Object value) {
	...
	public static boolean propertyValueContainsString(Annotation annotation, String property, Object value,
		...
		return (o != null && o.toString().toLowerCase().contains(value.toString().toLowerCase()));
	}

	public static boolean hasPropertyRecursive(Annotation annotation, String property) {
	...
	public static boolean hpv(Annotation annotation, String property, Object value) {
		return hasPropertyValue(annotation, property, value, false);
	}

	public static boolean hpvr(Annotation annotation, String property, Object value) {
		return hasPropertyValueRecursive(annotation, property, value);
	}

	public static boolean hasPropertyValue(Annotation annotation, String property, Object value) {
		return hasPropertyValue(annotation, property, value, false);
	}

	public static boolean hasPropertyValueRecursive(Annotation annotation, String property, Object value) {
		return hasPropertyValue(annotation, property, value, true);
	}

	public static boolean hasPropertyValue(Annotation annotation, String property, Object value, boolean recursive) {
	...
	public static boolean hcopvr(Annotation annotation, String property, Object value) {
		return hasConceptOrPropertyValue(annotation, property, value, true);
	}

	public static boolean hasConceptOrPropertyValue(Annotation annotation, String property, Object value,
			boolean recursive) {
	...
	public static Float getNumericPropertyValue(Annotation annotation, String property) {
		Annotation child = (Annotation) getChildAnnotationViaProperty(annotation, property);
	...
	public static Annotation getChildAnnotationViaProperty(Annotation annototion, String property) {
	...
	public static Annotation getChildAnnotationViaConcept(Annotation a, String concept) {
		if (a.hasConcept()) {
			if (a.getConcept().toString().equals(concept)) {
				return a;
			}
			if (a.getChildAnnotations() != null) {
				for (Annotation child : a.getChildAnnotations()) {
					Annotation rv = getChildAnnotationViaConcept(child, concept);
					if (rv != null) {
						return rv;
					}
				}
	...
	public static boolean annotationStringContains(Annotation annotation, Vector<String> strs) {
		for (String str : strs) {
	...
	public static boolean withinNSentences(Annotation a1, Annotation a2, Float n) {
		...
		boolean rv = (a1.getTextStart() < a2.getTextStart() && (si2 - si1 <= n));
			
		return rv;
	}

	public static boolean beforeNTokens(Annotation a1, Annotation a2, Float numTokens) {
	...
	public static boolean formattedTypesAreUnifiable(Annotation annotation) {
		if (annotation.getFormattedSourceAnnotations() != null) {
			Annotation last = null;
			for (Annotation child : annotation.getFormattedSourceAnnotations()) {
				if (last != null && !(last.getType() != null && child.getType() != null
						&& TypeConstant.isUnifiableBelowBase(last.getType(), child.getType()))) {
					return false;
				}
				last = child;
			}
	...
	public static boolean typesUnifiableBelowBase(Annotation a1, Annotation a2) {
		return TypeConstant.isUnifiableBelowBase(a1.getType(), a2.getType());
	}

	public static boolean sameConcept(Annotation a1, Annotation a2) {
		return a1.getConcept() != null && a1.getConcept().equals(a2.getConcept());
	}

	public static boolean typesAreSubsumedBy(TypeConstant t1, TypeConstant t2, Object t3) {
	...
	public static boolean annotationIsBetween(Annotation a1, Annotation a2, Annotation a3) {
		if (a1 instanceof Annotation && a2 instanceof Annotation && a3 instanceof Annotation) {
			if (a1.getTokenEnd() < a2.getTokenStart() && a2.getTokenEnd() < a3.getTokenStart()) {
				return true;
			}
		}
		return false;
	...
	public static Annotation applyModifierProperties(Rule rule, Annotation annotation) {
		boolean didModification = false;
		if (annotation != null && annotation.isInterpreted() && rule != null && rule.getPropertyPredicates() != null) {
			for (Vector pp : rule.getPropertyPredicates()) {
				String aname = (String) pp.firstElement();
				Object value = pp.lastElement();
				if (!value.equals(annotation.getProperty(aname))) {
					annotation.getSemanticInterpretation().setProperty(aname, value);
					didModification = true;
				}
			}
		}
		return (didModification ? annotation : null);
	}
	
	public static Annotation applyModifierPropertiesToConjunct(Rule rule, Annotation annotation) {
		if (annotation != null && annotation.getFormattedSourceAnnotations() != null
				&& rule != null && rule.getPropertyPredicates() != null) {
			for (Vector pp : rule.getPropertyPredicates()) {
				String aname = (String) pp.firstElement();
				Object value = pp.lastElement();
				for (Annotation child : annotation.getFormattedSourceAnnotations()) {
					if (child.getProperty(aname) == null) {
						child.getSemanticInterpretation().setProperty(aname, value);
						child.invalidateDerivativeAnnotations("InvalidatedViaModifierProperty");
						child.getGrammar().expandAnnotation(child);
					}
				}
				return annotation;
			}
	...
	// 6/9/2016 TEST
	public static Annotation invalidateSentence(Annotation annotation, String reason) {
	...
	public static String getConTextValue(TagAnnotation tag, Annotation annotation, Rule rule) {
		...
		if (Math.abs(second.getSentenceTokenEnd() - first.getSentenceTokenStart()) > rule.getWindow()) {
			return null;
		}
		...
		if (Annotation.intervalContainsStrings(tag, annotation, rule.getStopWords())) {
			return null;
		}
		if ("forward".equals(mdir) && tag.getTokenEnd() < annotation.getTokenStart()) {
			return mvalue;
		}
		if ("backward".equals(mdir) && tag.getTokenStart() > annotation.getTokenEnd()) {
			return mvalue;
		}
	...
	public static boolean annotationsStringsNotEqual(Annotation a1, Annotation a2) {
		boolean rv = !a1.getString().toLowerCase().equals(a2.getString().toLowerCase());
		return rv;
	}
	...
	public static boolean containsConjunct(Object o) {
		if (o instanceof Annotation) {
			Annotation annotation = (Annotation) o;
			return annotation.containsConjunct();
		}
		return false;
	}
	...
	public static boolean containsPOS(Annotation annotation, String pos) {
		...
		if (first != null && pos != null && first.isWord()) {
			...
			if (word == null || word.getPartsOfSpeech().contains(pos.toLowerCase())) {
				return true;
			}
		}
		return false;
	...
	public static boolean containsComma(Annotation annotation) {
		Vector<Token> tokens = annotation.getSentenceAnnotation().getSentence().getTokens();
	...
	public static boolean annotationTextContainsString(Annotation annotation, String str) {
	...
	// FOR VINCI
	public static boolean annotationTypeSubsumedBy(Annotation annotation, String tname) {
	...
	public static boolean containsUnderline(Annotation annotation) {
		...
		for (Token token : tokens) {
			if (token.getType() == Token.UNDERLINE) {
				System.out.println(annotation.toString() + ": contains underline");
				return true;
			}
		}
		return false;
	...
	public static Float getSentenceWordTokenLength(Annotation annotation) {
	...
	public static boolean doTest(Annotation annotation, Object item) {
		System.out.printf("IE: Annotation=%s, Item=%s\n", annotation.getText(), item);
		return true;
	}

	public static boolean hasNestedFirstEDFormActionWord(Annotation annotation) {
		if (isEDFormActionWord(annotation)) {
			return true;
		}
		if (annotation.hasChildren() && hasNestedFirstEDFormActionWord(annotation.getLexicalChild(0))) {
			return true;
		}
		return false;
	}

	public static boolean isEDFormActionWord_TEST(Annotation annotation) {
		if (annotation.getType() != null) {
			Token t = annotation.getTokens().firstElement();
			String str = t.getString();
			if (str.endsWith("ed") || str.endsWith("en")) {
				return true;
			}
		}
		return false;
	...
	public static boolean isEDFormActionWord(Annotation annotation) {
		if (annotation.getType() != null) {
			if (annotation.getType().containsBaseType("action")) {
				Token t = annotation.getTokens().firstElement();
				String str = t.getString();
				if (str.endsWith("ed") || str.endsWith("en")) {
					return true;
	...
	public static boolean textEndsWith(Annotation annotation, String ending) {
		return annotation != null && ending != null && annotation.getText().endsWith(ending);
	}

	public static void createConjunctWithDistributedModifiers(Annotation annotation, Rule rule) {
		if (annotation.isConjunct()) {
			annotation.createConjunctWithDistributedModifiers(rule);
		}
	}
	
	public static boolean isNarrativeAnnotation(Annotation annotation) {
		boolean rv = (annotation instanceof NarrativeAnnotation);
		return rv;
	}
